...
<div id="doc-main" class="container"><!-- a5 -->
    ...
    <div id="doc-main-hd" class="hd">
        <div id="header-section">
            <div class="item-logo">
                <h1>
                    <a id="imgLogo" class="default-logo" href="index.php" target="_self" title="OI导航,最贴心的上网导航">
                        <img src="images/logo.png">
                    </a>
                    <a id="themeLogo" class="theme-logo" href="index.php" target="_self" title="OI导航,最贴心的上网导航">OI导航</a>
                </h1>
            </div>
