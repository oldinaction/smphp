        ...
        <div id="nav-section">
            <div id="nav" class="theme-nav clearfix">
                <ul class="f-l nav-menu clearfix">
            		...
            		<li class="item" data-alias="email"><a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=aQgNBAAHKQYAAQgGRwoGBA" class="item-link theme-nav-item-link">留言</a></li>
                    <li class="item" data-alias="smalle"><a target="_self" href="smalle.php" class="item-link theme-nav-item-link">审核</a></li>
                </ul>
            </div>
        </div>
    </div>
